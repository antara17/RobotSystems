...
logging.getLogger().setLevel(logging.DEBUG)  # Set the logging level to DEBUG for detailed logs
...
class Picarx(object):
    ...
    # @log_on_start(logging.DEBUG, "Initializing Picarx with servos {servo_pins}, motors {motor_pins}")
    # @log_on_error(logging.ERROR, "Error encountered in Picarx initialization")
    # @log_on_end(logging.DEBUG, "Successfully initialized Picarx")
    def __init__(self, 
    ...
    # @log_on_error(logging.ERROR, "Failed to set motor {motor} speed")
    # @log_on_end(logging.DEBUG, "Motor {motor} speed set successfully")    
